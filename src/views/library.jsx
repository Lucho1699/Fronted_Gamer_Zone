...
//exportar un juego
// 📄 Exportar juegos a PDF
const exportarPDF = () => {
  const doc = new jsPDF();

  doc.setFontSize(18);
  doc.text("Lista de Juegos", 14, 20);
  ...
  autoTable(doc, {
    startY: 30,
    head: [["Nombre", "Género", "Desarrollador", "Descripción"]],
    body: filas,
  });
  ...
  return (
    <>
      ...
      <h2 className="header">🎮 Mi Biblioteca de Juegos</h2>
          <button className="btn-export" onClick={exportarPDF}>📄 Exportar juegos a PDF</button>
      <input
  type="text"
